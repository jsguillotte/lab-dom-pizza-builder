...
function renderPrice() {
  ...
  //document.querySelector('aside.panel.price ul').style.display = 'none'
  ...
  for(let el in ingredients) {
    ...
    if(state[el]) {
      ...
      document.querySelector('aside.panel.price ul').innerHTML += `<li>${ingredients[el].price} ${ingredients[el].name}</li>`
